...
public interface LabeledExprVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code questionnarie11}
	 * labeled alternative in {@link LabeledExprParser#start6}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQuestionnarie11(LabeledExprParser.Questionnarie11Context ctx);
	/**
	 * Visit a parse tree produced by the {@code questionnarie12}
	 * labeled alternative in {@link LabeledExprParser#start7}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQuestionnarie12(LabeledExprParser.Questionnarie12Context ctx);
	/**
